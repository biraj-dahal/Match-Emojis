# Project 4 - *Match Emojis*

Submitted by: **Biraj Dahal**

**Match Emojis** is a game app where users test their memory skills by trying to match the flipped cards.
...
- [x] When two matching cards are found, they both disappear from view:
  ...
  - If they match, both cards should either disappear. (I could have made it disappear but for aesthetics of the game, I made it green so user could know its already done.)
...
- [x] Add any flavor you’d like to your UI with colored buttons or backgrounds, unique cards, etc. 
  ...
  * I have added 3D rotating animation effect, and added colors to the matched tiles which is appealing.

The following **additional** features are implemented:

- [x] List anything else that you can get done to improve the app functionality!
  * I added a functionality to the app by keeping track of win condition, and when theres a win condiion(meaning all pairs are matched), it shows an alert box mentioning you have won the match, and play again resets the game state.

## Video Walkthrough

![SimulatorScreenRecording-iPhone16Pro-2025-02-17at09 32 18-ezgif com-optimize](https://github.com/user-attachments/assets/ed6dd726-321f-41bc-8af9-f2232e164bea)
